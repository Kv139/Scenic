...
def check_env(
    ...
    print("Checking observation_space")
    ...
    print("Checking Seed determinism")
    ...
    print("Checking returned values")
    time.sleep(10)
...
print(env.reset)
this = env.reset()
print(this, "Reset returned", type(this), type(env.observation_space.sample()))
#check_env(env, skip_close_check=True,skip_render_check=True) # unclear what is actually failing in this
